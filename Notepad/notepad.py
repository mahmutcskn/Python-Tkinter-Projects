...
def new_note():
    """Make a new Note which essemtially clears the screen."""
...
def close_note():
    """Closes the note which essentailly close your program."""
...
def save_note():
    """Save the given note. First theree lines are saved as font family, font size, and font option."""
    #Use filedialog to get location and name of where/what tı save the file as.
...
def open_note():
    """Open previously saved note. First three lines of note are font family, font size, and font option.First set the font, then load the text."""
    ...
    with open(open_name, 'r') as f:
        ...
        #First three lines of save file are font_family, font_size and font_options...You must strip the new line char at the end of each line.
...
#Layout and Menu Frame
#Make the menu: new ,open, save, close, font size, font option
...
#Make input_text as a scrolltext so you can scroll through the text field.
